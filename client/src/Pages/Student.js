  ...
  return (
    <div>
      ...
      <div className="options">
        ...
        />
        <label className="subpages text-white" htmlFor="complaint">
          Complaint
        </label>
        ...
        <input
          ...
          className="option-button"
        />
        <label className="subpages text-white" htmlFor="status">
          Check Status
        </label>
      </div>
      ...
      {selectedOption === "complaint" && (
        <div>
          ...
          <div className="box">
            <div className="head">
              <h2 className="text-black" class="gradient-text_b">
                Make a complaint
              </h2>
              <h3 className="text-black" class="gradient-text_r">
                {" "}
